      ...
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="30" background="Images/mainMenuBg.jpg" style="padding-left:25px;">学生宿舍调换</td>
            </tr>
            <tr>
              ...
              <form name="form1" method="post" action="StudentTHSave.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td width="33%" height="30" align="right">目前宿舍：</td>
                  ...
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>调换到宿舍：</td>
